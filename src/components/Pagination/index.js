...
//       navigate(`/dashboard/${Math.min(currentPage + 1, totalPages - 1)}`); 
//       setScroll();
//     }
//   };
...
//       navigate(`/dashboard/${Math.max(currentPage - 1, 0)}`);
//       setScroll();
//     }
//   };
...
//   const handlePageChange = (number) => {
//     onPageChange(number);
//     navigate(`/dashboard/?query=${encodeURIComponent(query)}&page=${number}`);
//   };
